...
#include QUOTE(_MARTe2_DIR/Source/Core/BareMetal/L1Portability/HeapI.h)
#include QUOTE(_MARTe2_DIR/Source/Core/BareMetal/L1Portability/Environment/Generic/StandardHeap_Generic.h)
